    ...
    <form action="thanks.php" method="post" id="survey-form">
        <fieldset class="personnal-info">
            ...
            <div class="field">
                ...
                <input type="tel" name="number" id="number" class="form-control" placeholder="06 ..." required/>
            </div>
            ...
            <div class="field">
                ...
                <textarea name="message" id="message" rows="5" placeholder="Enter your comment here..." required></textarea>
            </div>
